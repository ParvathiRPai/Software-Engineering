...
namespace DataProvider
{
    ...
    public partial class AdventureWorksEntities : DbContext
    {
        ...
        public virtual ObjectResult<Customer> cuspCustomerSelect(Nullable<int> customerID)
        {
            var customerIDParameter = customerID.HasValue ?
                new ObjectParameter("CustomerID", customerID) :
                new ObjectParameter("CustomerID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Customer>("cuspCustomerSelect", customerIDParameter);
        }
    
        public virtual ObjectResult<Customer> cuspCustomerSelect(Nullable<int> customerID, MergeOption mergeOption)
        {
            var customerIDParameter = customerID.HasValue ?
                new ObjectParameter("CustomerID", customerID) :
                new ObjectParameter("CustomerID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Customer>("cuspCustomerSelect", mergeOption, customerIDParameter);
        }
        ...
        public virtual ObjectResult<Product> cuspProductSelect(Nullable<int> productID)
        {
            var productIDParameter = productID.HasValue ?
                new ObjectParameter("ProductID", productID) :
                new ObjectParameter("ProductID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Product>("cuspProductSelect", productIDParameter);
        }
    
        public virtual ObjectResult<Product> cuspProductSelect(Nullable<int> productID, MergeOption mergeOption)
        {
            var productIDParameter = productID.HasValue ?
                new ObjectParameter("ProductID", productID) :
                new ObjectParameter("ProductID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Product>("cuspProductSelect", mergeOption, productIDParameter);
        }
